...
app.get("/posts/add-post", function(req, res) {
...
app.post("/posts/add-post", upload.single("postImage"), function(req, res) {
...
app.get("/photos/:photoTheme/add-photo", function(req, res) {
  if (req.isAuthenticated()) {
    res.render("add-photo", {photoTheme: req.params.photoTheme});
  } else {
    res.redirect("/login");
  }
});

app.post("/photos/:photoTheme/add-photo", upload.single("photoImage"), function(req, res, next) {
...
app.get("/photos/:photoTheme/:id", function(req, res) {
...
app.get("/photos/:photoTheme/:id/delete", function(req, res) {
